# FFmpeg Static Auto-Builds (Fork with svt-av1-psyex)

Static Windows (x86_64) and Linux (x86_64) Builds of ffmpeg master and latest release branch, featuring svt-av1-psyex.
